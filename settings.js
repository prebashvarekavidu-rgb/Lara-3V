...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "HcYi1B6T#HSUzSy-sFJZslobKqoYuLIfv8kdKlghNher2ZqVeBZw", // Add your session id
PREFIX: process.env.PREFIX || ".",
MODE: process.env.MODE || "public",  //public | private | inbox | group
OWNER_NUMBER: process.env.OWNER_NUMBER || "94771640647",
DEV: process.env.DEV || "94771640647",
LANG: process.env.LANG || "EN", // EN | SI
AUTO_READ_STATUS: process.env.AUTO_READ_STATUS || "true",
AUTO_STATUS_REACT: process.env.AUTO_STATUS_REACT || "🧐,😕,🫤,😟,☹️,😮,🩷,🧡,💛,💚,💙,🩵,💜,🤎,🖤,🩶,🤍,❤️‍🔥,❤️‍🩹,❤️,💯,💓,💗,💝,🔥,💘,😭,😎🥹,😎,😖,😱,😭,😰,😨,😧,😦,🥺,🥸,🤓,",
